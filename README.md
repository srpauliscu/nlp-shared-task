...
Data note: The current implementation of our model was developed with the training dataset exclusively, prior to the release of the official validation and test datasets.  
